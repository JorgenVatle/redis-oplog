...
import { MeteorQueue } from "../utils/meteorQueue";
...
export default function PollingObserveDriver(options) {
  ...
  self._stopCallbacks = [];
  self._stopped = false;
  self._asynchronousCursor = (self._mongoHandle._createAsynchronousCursor || self._mongoHandle._createSynchronousCursor)(
  ...
  self._taskQueue = new MeteorQueue();
